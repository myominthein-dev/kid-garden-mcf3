    ...
    <section className=" relative">
      <>
        <img
          src={leftBumpOrange}
          alt="leftBumpOrange"
          className="absolute md:h-[640px]  h-[540px] md:-left-16 -left-12 top-8 md:top-10"
        />
        <img
          src={leftBumpPink}
          alt="leftBumpPink"
        ...
        <img
          src={Butterfly}
          alt="butterFly"
          className=" absolute top-20 left-28 z-20 w-20 h-20"
        />
        <img
          src={happyGirl}
          alt="happyGirl"
          className=" left-2 bottom-12 absolute z-20 w-80 h-80"
        />
        <img
          src={bean}
          alt="bean"
          className="absolute top-32 right-24 h-20 w-20"
        />
        <motion.img
          src={paperAeroPlane}
          alt="paperAeroPlane"
          className="absolute bottom-2 right-52 md:right-72 xl:right-96 h-28 w-28"
          initial={{ x: -15, y: -10 }}
          animate={{ x: 0, y: 0 }}
          transition={{
            duration: 2,
      ...
      <Container>
        <div className=" flex flex-col py-24 gap-20 justify-center items-center w-full h-full relative min-h-screen">
