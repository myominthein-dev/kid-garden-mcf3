...
const HomeCategories = () => {
  const categories = [
    ...
    },
    {
      ...
      title: "အနုပညာနှင့် တီထွင်မှုများ",
      bgColor: "#FB923C",
      borderColor: "#FB923C",
    },
    {
      ...
      title: "သင်္ချာနှင့်ကိုင်တွယ်ခြင်း",
      bgColor: "#F0ABFC",
      borderColor: "#F0ABFC",
    },
    {
  ...
  return (
    <Container>
      ...
      >
        <motion.h1 className="sub-heading" variants={titleVariants}>သင်တန်းအမျိုးအစားများ</motion.h1>
        <motion.img
          src={starOrange}
          alt="Orange Star"
