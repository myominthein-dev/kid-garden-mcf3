      ...
      <div className=" absolute xl:p-10 w-full h-full top-0 left-0">
        ...
        >
          <div className=" md:w-[80%] w-[95%] ">
            <motion.img ref={ref} initial='hidden' animate={controls} variants={imageVariants} className=" md:w-full" src={ImageUrl} alt="" />
          </div>
          <div className=" flex flex-col gap-12 xl:w-[628px] md:w-[80%] w-[90%] ">
            <div className=" flex flex-col gap-4">
              <motion.h1 ref={ref} initial='hidden' animate={controls} variants={titleVariants} className="font-semibold text-[36px] leading-[54px] font-poppin text-orange-600">
                What Your Kid Will Learn
              </motion.h1>
              <motion.p ref={ref} initial='hidden' animate={controls} variants={titleVariants} className="font-normal text-[20px] leading-[30px] font-roboto text-neutral-700">
                {text}
              </motion.p>
            </div>
