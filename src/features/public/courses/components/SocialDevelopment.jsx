...
const SocialDevelopment = () => {
  ...
  return (
    <Container className={"my-16 py-5"}>
      <motion.div ref={ref} initial='hidden' animate={controls} variants={containerVariants} className="max-w-[1183px]  relative  mx-auto">
        <motion.h1 ref={ref} initial='hidden' animate={controls} variants={titleVariants} className="font-poppin w-full md:w-[618px] mx-auto font-semibold leading-10 text-4xl text-center">
        ...
        <div className="relative   flex items-center justify-center gap-10 ">
          <div className="relative   flex md:justify-evenly xl:justify-between items-center md:w-full xl:w-4/5 md:h-[600px] xl:h-[900px] mx-auto ">
            <div className="bg-white absolute md:w-[225px] xl:w-[180px] w-[50%] px-7 py-0   shadow-neutral-400 shadow-lg top-[40%] md:top-48 left-5  md:left-0 md:right-0 mx-auto rounded-full xl:px-5 md:px-8 xl:py-2 md:py-1 z-30 ">
              <motion.h3 ref={ref} initial='hidden' animate={controls} variants={titleVariants} className="text-[#FF9E0E] text-4xl ">24</motion.h3>
              <motion.h3 ref={ref} initial='hidden' animate={controls} variants={titleVariants} className="leading-9  text-[#333931]">National Students</motion.h3>
            </div>
            <div className="absolute  top-20 right-0">
              <motion.img ref={ref} initial='hidden' animate={controls} variants={imageVariants}
                className="size-14 top-3  absolute  z-20"
                src={potato}
                alt=""
              />
              <motion.img ref={ref} initial='hidden' animate={controls} variants={imageVariants} className="size-16   " src={outerPotato} alt="" />
            </div>
            <motion.img ref={ref} initial='hidden' animate={controls} variants={imageVariants} className="absolute top-0 -left-32" src={arrowSvg} alt="" />
            <motion.img ref={ref} initial='hidden' animate={controls} variants={imageVariants}
